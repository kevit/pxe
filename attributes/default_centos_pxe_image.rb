...
default['http-chef-pxe']['ks_filename'] = 'Centos6-6.minimal.ks'
default['http-chef-pxe']['port'] = 90
default['apache']['listen_ports'] = [node['http-chef-pxe']['port']]

# ISO Configuration
default['iso']['name'] = 'CentOS-6.6-x86_64-minimal.iso'
...
default['image']['url'] = 'http://ftp.tlk-l.net/pub/mirrors/centos.org/6.6/isos/x86_64/CentOS-6.6-x86_64-minimal.iso' #http://ftp.tlk-l.net/pub/mirrors/centos.org/6.5/isos/x86_64/CentOS-6.5-x86_64-minimal.iso
